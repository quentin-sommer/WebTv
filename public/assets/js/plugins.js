        ...
        t.snowfall = function(e, i) {
            ...
            if (i.collection !== !1) {
                ...
                if (m.getContext && m.getContext("2d"))
                    for (var u = [], w = t(i.collection), g = i.collectionHeight, r = 0; r < w.length; r++) {
                        var x = w[r].getBoundingClientRect(),
...
! function() {
    function e() {
        ...
        for (var e = 0; v > e; e += v / 20)
            for (var t = 0; h > t; t += h / 20) {
                var n = e + Math.random() * v / 20,
                    o = t + Math.random() * h / 20,
                    i = {
                        x: n,
                        originX: n,
                        y: o,
    ...
    function l(e) {
        if (e.active)
            for (var t in e.closest) m.beginPath(), m.moveTo(e.x, e.y), m.lineTo(e.closest[t].x, e.closest[t].y), m.strokeStyle = "rgba(255,255,255," + e.active + ")", m.stroke()
    }
